...
export class CustomerFeedbackService {
  ...
  async createFeedback(payload: any) {
    ...
    const feedbackData: Partial<CustomerFeedback> = {
      ...
      powerOutputOfModulesRating: quality.powerOutputOfModules?.rating || 0,
      powerOutputOfModulesComment: quality.powerOutputOfModules?.comment || '',
    ...
    const allRatings = [
      ...
      { label: 'Power Output of Modules', score: quality.powerOutputOfModules?.rating || 0 },
